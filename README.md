...
It focuses on achieving high a# Spam Detection Classifier
...
The models in this project are trained on the following dataset:

https://huggingface.co/datasets/locuoco/the-biggest-spam-ham-phish-email-dataset-300000

This dataset contains a large collection of labeled emails across ham, spam, and phishing categories, enabling robust multi-class classification.
...
The distilled model achieves near-teacher performance with a fraction of the size.ccuracy while also optimizing model size and efficiency for deployment.
